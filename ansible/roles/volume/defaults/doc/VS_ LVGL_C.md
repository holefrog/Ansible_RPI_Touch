...
git clone --recursive [https://github.com/lvgl/lv_port_pc_vscode.git](https://github.com/lvgl/lv_port_pc_vscode.git)
...
1. **打开项目**：在当前项目根目录下运行 `code .` 直接拉起 VS Code。
...
打开项目根目录下的 **`main.c`**，找到 `main` 函数，将其中的官方 Demo 注释掉，换上你纯 C 语言构建的 LMS 播放器 UI 入口：
