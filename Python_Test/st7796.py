...
SPI_Freq = 20000000     # SPI 时钟频率 (降频至20MHz以提高物理线材连接时的稳定性)
SPI_Mode = 0            # 模式0
RST_PIN  = 27
DC_PIN   = 25
BL_PIN   = 13
...
class st7796():
    def __init__(self):
        ...
        self.GPIO_BL_PIN  = DigitalOutputDevice(BL_PIN,active_high = True,initial_value =True)     # 改为纯数字输出，避免Bookworm下PWM无输出Bug，强制背光常亮
        #Initialize SPI
